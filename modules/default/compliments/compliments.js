...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			...
			morning: ["Good morning, sunshine!", "You look ready to conquer the day!", "Have a good workout!", "Lets get that bread!", "You are early today"],
			afternoon: ["Hitting your stride!", "You are making a difference!", "Take a mid day break!", "Have you had enough water today?"],
			evening: ["You killed it today!", "The day was better for your efforts", "See you tomorrow!", "Sleep tight"],
